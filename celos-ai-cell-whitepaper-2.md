...
Working paper — v1.1 (software-only evidence). Not yet peer reviewed. No patents filed. September 2026
...
2. `cellos-emulator v0.1` — the Python reference implementation used for the experiments above (routing, benchmark harness, fault-injection harness) — in progress; not yet a released package.
3. Provisional patent filing — planned; not yet filed.
4. FPGA emulation & edge-vision reflex benchmarks — planned; would be the first hardware-adjacent validation of the concurrency claim in Section 4.2.
5. Custom silicon tape-out — planned, contingent on Phase 4 results.
